...
func newRealClient(t *testing.T, graphSpace string) *hugegraph.CommonClient {
	t.Helper()
...
func requireServer(t *testing.T, graphSpace string) *hugegraph.CommonClient {
	t.Helper()
...
func TestTraverserAPIErrorsImplementsError(t *testing.T) {
	...
	wrapped := error(&APIError{StatusCode: 400, Message: "boom"})
	var apiErr *APIError
